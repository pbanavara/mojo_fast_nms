...
fn nms_kernel(boxes: PythonObject, scores: PythonObject, iou_threshold: PythonObject) raises -> PythonObject:
    """GPU NMS kernel that can be called from Python/PyTorch."""
...
fn benchmark_kernel(n_boxes: PythonObject, iou_threshold: PythonObject, num_trials: PythonObject) raises -> PythonObject:
    """Benchmark the NMS kernel."""
...
# Export the functions as PythonObjects
fn get_nms_kernel() -> PythonObject:
    """Get the NMS kernel function as a PythonObject."""
    return Python.evaluate("lambda boxes, scores, iou_threshold: nms_kernel(boxes, scores, iou_threshold)")

fn get_benchmark_kernel() -> PythonObject:
    """Get the benchmark function as a PythonObject."""
    return Python.evaluate("lambda n_boxes, iou_threshold, num_trials: benchmark_kernel(n_boxes, iou_threshold, num_trials)") 